...
// foreach does not return any value only show undefined
...
filter bydefault use callback values
...
const newNuma = myNumers.map((num) => { return num + 10 })
...
const shoppingCart = [{
        itemName: "JavaScript coursë",
        price: 999
    },
    {
        itemName: "Python coursë",
        price: 1999
    },
    {
        itemName: "Java coursë",
        price: 2999
    },
    {
        itemName: "C++ coursë",
